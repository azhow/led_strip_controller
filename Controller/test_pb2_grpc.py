...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetColor = channel.unary_unary(
                '/Greeter/SetColor',
                request_serializer=test__pb2.SetColorRequest.SerializeToString,
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SetColor': grpc.unary_unary_rpc_method_handler(
                    servicer.SetColor,
                    request_deserializer=test__pb2.SetColorRequest.FromString,
...
class Greeter(object):
    ...
    def SetColor(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Greeter/SetColor',
            test__pb2.SetColorRequest.SerializeToString,
